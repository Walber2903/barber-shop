...
async function seedDatabase() {
  try {
    ...
    // Fictitious address to barber shop
    const addresses = [
        "Barber Street, 123",
        "Cortes Avenue, 456",
        "Beard Square, 789",
    ...
    const services = [
      ...
      {
        name: "hair corners",
        description: "Perfect finishing on the corners of the hair for a renewed look.",
        price: 35.0,
        imageUrl:
    ...
    // Create 10 barbar shop with name and fictitious address
    const barbershops = [];
    for (let i = 0; i < 10; i++) {
    ...
    console.error("Error to create barber shop:", error);
  }
}
